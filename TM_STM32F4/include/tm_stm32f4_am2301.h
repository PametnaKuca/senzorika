...
// declaration of temperature and humidity variables



typedef struct {
	
	float temperature;   //exact float value of temperature in Celsius degrees, example 27.332
	float humidity; 		//exact float value of relative humidity in %, example 55.423
